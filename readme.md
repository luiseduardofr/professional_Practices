[![🤖CI Regression in QA🧪](https://github.com/upex-galaxy/cypress-cucumber/actions/workflows/CI-regressionQA.yml/badge.svg)](https://github.com/upex-galaxy/cypress-cucumber/actions/workflows/CI-regressionQA.yml)
